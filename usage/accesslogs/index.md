...
date: "2021-05-12"
weight: 30
id: "144e712ca6d9c92e0b502fc325a3dc83"
---
...
在生产环境中，有时我们不想全局启用 accesslog，我们可以利用 EnvoyFilter 来实现只为部分 namespace 或 workload 启用 accesslog，参考 [实用技巧: 局部启用 accesslog](https://imroc.cc/istio/trick/partially-enable-accesslog/)
